    ...
    return __generator(this, function(n6) {
      switch (n6.label) {
        case 0:
          return n6.trys.push([0, 3, , 4]), t2 = new TextEncoder().encode(e10), [4, v4(r10)];
        case 1:
          for (o7 = n6.sent(), c14 = atob(s11), d8 = new Uint8Array(c14.length), u13 = 0; u13 < c14.length; u13++)
            d8[u13] = c14.charCodeAt(u13);
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r10) {
      switch (r10.label) {
        ...
        case 5:
          if (g10) {
            if (k4 = f14.iss !== "https://access.".concat("line.me"), C6 = f14.aud !== o7, F4 = 1e3 * f14.exp < Date.now(), k4)
      ...
      switch (r10.label) {
        ...
        case 2:
          if (t2.error && t2.liffOAuth2Error)
            throw a10 = t2.error, c14 = t2.error_description, l13 = c14.replace(/\+/g, " "), f14 = "".concat(a10, ": ").concat(l13), w(I, f14);
    ...
    return __generator(this, function(n6) {
      switch (n6.label) {
        ...
        case 1:
          ...
          try {
            for (u13 = __values(o7), f14 = u13.next(); !f14.done; f14 = u13.next())
              if (f14.value.includes(r10))
...
function p10(n6) {
  ...
  var u13 = r5();
  if (u3())
    if (null !== u13 && "ios" === e6() && f2(u13, "9.19") >= 0 || !window._liff.postMessage) {
        ...
        switch (e10.label) {
          case 0:
            if (t2 = A2.parse(window.location.search), this.prepareReferrer(t2), i6 = E3(), !(r10 = null == i6 ? void 0 : i6.utsTracking))
              return [2];
            if (u14 = c5(), d9 = u14.liffId, h6 = u14.analytics, "auto" !== r10.mode || !h6)
              return [3, 6];
