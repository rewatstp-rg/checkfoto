...
export function CardItem({ card }: CardItemProps) {
  const { id, cardHolder, cardNumber, cardValid } = card;
      ...
      <Stack justifyContent="space-between" sx={{ height: 1, p: 3 }}>
        ...
        <div>
          ...
          <Stack direction="row" alignItems="center" spacing={1}>
            {/* <img
              src='https://run.checkrace.com/shared-image/event-image/scenicseries2/banner/20250129181548_file_1738149344096_z0h3mi.webp'
              alt="3D Effect"
              width={150}
              style={{ borderRadius: 8 }}
            /> */}
            <Typography sx={{ typography: 'subtitle1', fontSize: 36 }}>
              {cardNumber}
            </Typography>
          </Stack>
        </div>
