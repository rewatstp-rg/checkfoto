...
type PhotoItemSkeletonProps = StackProps & {
  variant?: 'vertical' | 'horizontal';
};

export function PhotoItemSkeleton({ variant = 'vertical', sx, ...other }: PhotoItemSkeletonProps) {
...
export function PhotoDetailsSkeleton({ ...other }: StackProps) {
  return (
    <Stack {...other}>
