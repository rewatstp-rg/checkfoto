...
export default function CarouselArrows({
  ...
  return (
    <Stack direction="row" tabIndex={-1} aria-hidden="true" alignItems="center" display="inline-flex" sx={sx} {...other}>
      <StyledIconButton tabIndex={-1} aria-hidden="true" filled={filled} shape={shape} onClick={onPrev} {...leftButtonProps}>
        <LeftIcon icon={icon} isRTL={isRTL} />
      </StyledIconButton>

      <StyledIconButton tabIndex={-1} aria-hidden="true" filled={filled} shape={shape} onClick={onNext} {...rightButtonProps}>
        <RightIcon icon={icon} isRTL={isRTL} />
      </StyledIconButton>
    </Stack>
  );
