  ...
  return (
    ...
    >
      <Grid container columnSpacing={{ md: 3 }} alignItems="flex-start">
        {mdUp && (
          <Grid  xs={12} md={6} lg={7} alignItems="center" sx={{ pr: { md: 7 } }}>
            <Grid xs={12}>
              <m.div variants={varFade().inUp}>
                <Image
                  alt="our office 2"
                  src="/assets/images/about/woman-doing-sport-with-hand-drawn-doodles.jpg"
                  ratio="1/1"
        ...
        <Grid xs={12} md={6} lg={5}>
          ...
          <m.div variants={varFade().inRight}>
            ...
            >
              บริษัท เรซอัพ เวิร์ค จำกัด เป็นบริษัทฯประกอบกิจการบริการด้านกีฬาทุกประเภท แบบครบวงจร
              <br />
              <br /> แพลตฟอร์มสำหรับ รับสมัครงานวิ่ง, งานเทรล, งานไตรกีฬา และอื่น ๆ
              <br /> แพลตฟอร์มสำหรับ Virtual Run
            </Typography>
          </m.div>
